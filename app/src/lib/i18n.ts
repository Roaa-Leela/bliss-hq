...
export const messages: Record<string, Entry> = {
  ...
  "rev.areasN": { en: "{n} areas · photos by area", hi: "{n} एरिया · एरिया अनुसार फोटो", te: "{n} ఏరియాలు · ఏరియా వారీగా ఫోటోలు" },
  ...
  "trade.carpentry": { en: "Carpentry", hi: "बढ़ईगीरी", te: "వడ్రంగం" },
  "trade.painting": { en: "Painting", hi: "पेंटिंग", te: "పెయింటింగ్" },
  "vend.vd9": { en: "Sri Venkateswara Carpentry", hi: "श्री वेंकटेश्वर कारपेंट्री", te: "శ్రీ వెంకటేశ్వర కార్పెంట్రీ" },
  "vend.vd10": { en: "ColourKraft Painters", hi: "कलरक्राफ्ट पेंटर्स", te: "కలర్‌క్రాఫ్ట్ పెయింటర్స్" },

  // Maintenance Tracker types
  "mt.plumbing": { en: "Plumbing", hi: "प्लंबिंग", te: "ప్లంబింగ్" },
  "mt.electrical": { en: "Electrical", hi: "इलेक्ट्रिकल", te: "ఎలక్ట్రికల్" },
  "mt.ac": { en: "AC / HVAC", hi: "एसी / HVAC", te: "ఏసీ / HVAC" },
  "mt.appliance": { en: "Appliance", hi: "उपकरण", te: "పరికరం" },
  "mt.pool": { en: "Pool", hi: "पूल", te: "పూల్" },
  "mt.garden": { en: "Garden", hi: "बगीचा", te: "తోట" },
  "mt.carpentry": { en: "Carpentry", hi: "बढ़ईगीरी", te: "వడ్రంగం" },
  "mt.painting": { en: "Painting", hi: "पेंटिंग", te: "పెయింటింగ్" },
  "mt.pest": { en: "Pest control", hi: "पेस्ट कंट्रोल", te: "పెస్ట్ కంట్రోల్" },
  "mt.housekeeping": { en: "Housekeeping", hi: "हाउसकीपिंग", te: "హౌస్‌కీపింగ్" },
  "mt.structural": { en: "Structural", hi: "स्ट्रक्चरल", te: "స్ట్రక్చరల్" },

  // Ownership / responsibility
  "ow.PM": { en: "Manager", hi: "मैनेजर", te: "మేనేజర్" },
  "ow.CT": { en: "Caretaker", hi: "केयरटेकर", te: "కేర్‌టేకర్" },
  "ow.VD": { en: "Vendor", hi: "वेंडर", te: "వెండర్" },
  "ow.OWN": { en: "Owner", hi: "मालिक", te: "యజమాని" },
  "iss.type": { en: "Type", hi: "प्रकार", te: "రకం" },
  "iss.ownership": { en: "Responsibility", hi: "ज़िम्मेदारी", te: "బాధ్యత" },
  "iss.quote": { en: "Quoted amount", hi: "कोटेशन राशि", te: "కోటేషన్ మొత్తం" },
  "iss.noQuote": { en: "Not quoted", hi: "कोई कोटेशन नहीं", te: "కోటేషన్ లేదు" },
  "ix.restock": { en: "Restock guest toiletries", hi: "मेहमान टॉयलेटरीज़ भरें", te: "అతిథి టాయిలెట్రీస్ నింపండి" },

  // Staff / caretaker profile
  "stf.title": { en: "Caretaker", hi: "केयरटेकर", te: "కేర్‌టేకర్" },
  "stf.assigned": { en: "Assigned to {prop}", hi: "{prop} को सौंपा", te: "{prop}‌కు కేటాయించబడింది" },
  "stf.contact": { en: "Contact", hi: "संपर्क", te: "సంప్రదింపు" },
  "stf.phone": { en: "Phone", hi: "फोन", te: "ఫోన్" },
  "stf.emergency": { en: "Emergency contact", hi: "इमरजेंसी संपर्क", te: "అత్యవసర సంప్రదింపు" },
  "stf.personal": { en: "Personal", hi: "व्यक्तिगत", te: "వ్యక్తిగతం" },
  "stf.age": { en: "Age", hi: "उम्र", te: "వయస్సు" },
  "stf.gender": { en: "Gender", hi: "लिंग", te: "లింగం" },
  "stf.address": { en: "Address", hi: "पता", te: "చిరునామా" },
  "stf.aadhaar": { en: "Aadhaar", hi: "आधार", te: "ఆధార్" },
  "stf.aadhaarNote": { en: "Stored encrypted, last 4 shown", hi: "एन्क्रिप्टेड, अंतिम 4 दिख रहे", te: "ఎన్‌క్రిప్ట్ చేయబడింది, చివరి 4 చూపబడ్డాయి" },
  "stf.employment": { en: "Employment", hi: "रोज़गार", te: "ఉద్యోగం" },
  "stf.joined": { en: "Joined", hi: "शामिल हुए", te: "చేరారు" },
  "stf.salary": { en: "Salary (monthly)", hi: "वेतन (मासिक)", te: "జీతం (నెలవారీ)" },
  "stf.duty": { en: "Duty hours", hi: "ड्यूटी घंटे", te: "డ్యూటీ గంటలు" },
  "stf.weeklyOff": { en: "Weekly off", hi: "साप्ताहिक अवकाश", te: "వారపు సెలవు" },
  "stf.accommodation": { en: "Accommodation", hi: "आवास", te: "నివాసం" },
  "stf.languages": { en: "Languages", hi: "भाषाएं", te: "భాషలు" },
  "stf.duties": { en: "Duties", hi: "कर्तव्य", te: "కర్తవ్యాలు" },
  "stf.training": { en: "Training", hi: "प्रशिक्षण", te: "శిక్షణ" },
  "stf.trained": { en: "Completed", hi: "पूरा", te: "పూర్తయింది" },
  "stf.untrained": { en: "Pending", hi: "बाकी", te: "పెండింగ్" },
  "gen.male": { en: "Male", hi: "पुरुष", te: "పురుషుడు" },
  "gen.female": { en: "Female", hi: "महिला", te: "స్త్రీ" },
  "acc.on": { en: "On-property", hi: "प्रॉपर्टी पर", te: "ఆస్తిపై" },
  "acc.off": { en: "Off-property", hi: "प्रॉपर्टी से बाहर", te: "ఆస్తి బయట" },
  "duty.full": { en: "Pre check-in, housekeeping, pool", hi: "प्री चेक-इन, हाउसकीपिंग, पूल", te: "ప్రీ చెక్-ఇన్, హౌస్‌కీపింగ్, పూల్" },
  "duty.house": { en: "Housekeeping and laundry", hi: "हाउसकीपिंग और लॉन्ड्री", te: "హౌస్‌కీపింగ్, లాండ్రీ" },
  "day.mon": { en: "Monday", hi: "सोमवार", te: "సోమవారం" },
  "day.tue": { en: "Tuesday", hi: "मंगलवार", te: "మంగళవారం" },
  "day.wed": { en: "Wednesday", hi: "बुधवार", te: "బుధవారం" },
  "adm.viewProfile": { en: "View", hi: "देखें", te: "చూడండి" },
  "adm.staff": { en: "Staff", hi: "स्टाफ", te: "సిబ్బంది" },
  ...
  "inv.iv10": { en: "Bathroom cleaner", hi: "बाथरूम क्लीनर", te: "బాత్రూమ్ క్లీనర్" },
  "inv.iv11": { en: "OTG oven", hi: "OTG ओवन", te: "OTG ఓవెన్" },
  "inv.iv12": { en: "Mixer grinder", hi: "मिक्सर ग्राइंडर", te: "మిక్సర్ గ్రైండర్" },
  "inv.iv13": { en: "Soup bowls", hi: "सूप बाउल", te: "సూప్ బౌల్స్" },
  "inv.iv14": { en: "Pillow covers", hi: "तकिया कवर", te: "దిండు కవర్లు" },
  "inv.iv15": { en: "Shampoo (5L)", hi: "शैम्पू (5L)", te: "షాంపూ (5L)" },
  "inv.iv16": { en: "Glass cleaner", hi: "ग्लास क्लीनर", te: "గ్లాస్ క్లీనర్" },
  "inv.brand": { en: "Brand", hi: "ब्रांड", te: "బ్రాండ్" },
  "inv.code": { en: "Diversey {c}", hi: "डाइवर्सी {c}", te: "డైవర్సీ {c}" },
